...
O projeto foi construído como uma **SPA (Single Page Application)**, ou seja, todo o conteúdo carrega em uma única página e o usuário navega pelas seções sem precisar recarregar o navegador.
...
* **JavaScript (Vanilla):** Toda a lógica do site rodando direto no navegador, sem frameworks externos.
...
* **Dark Mode:** Alternador de tema (claro/escuro) que muda as variáveis de cores do sistema.
* **Quiz Educativo:** Jogo de perguntas e respostas com validação de acertos em tempo real.
* **Performance:** Imagens configuradas com `loading="lazy"` para carregar o site mais rápido.
...
* **Idade:** 15 anos
* **Escola:** Colégio Estadual Cívico Militar Dr. Generoso Marques
* **Papel no projeto:** Desenvolvimento Front-End, Design e Programação JS.
* **Contato:** @pedro_batistavz
